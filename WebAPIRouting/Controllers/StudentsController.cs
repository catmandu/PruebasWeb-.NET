...
namespace WebAPIRouting.Controllers
{
    ...
    public class StudentsController : ApiController
    {
        ...
        [Route("{id:int:range(1,3)}")]//[Route("{id:int:min(1):max(3)}")]
        ...
        {
            return students.FirstOrDefault(s => s.Name == name.ToLower());
        }
        ...
        public IEnumerable<string> GetStudentCourses(int id)
        {
            if (id == 1)
                ...
                return new List<string>() { "Bootstrap", "jQuery", "SQL AngularJs" };
        }
